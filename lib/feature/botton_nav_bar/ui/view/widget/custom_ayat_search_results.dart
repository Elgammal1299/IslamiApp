  ...
  Widget build(BuildContext context) {
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        // التعديل هنا: sora بدل surah، وaya_no بدل verse
        final int surah = result["sora"];
        final int verse = result["aya_no"];

        final verseText = getVerse(surah, verse, verseEndSymbol: true);
        ...
        return Padding(
          ...
          child: EasyContainer(
            ...
            child: Column(
              ...
              children: [
                Text(
                  "سورة ${getSurahNameArabic(surah)} - الآية $verse",
                  style: context.textTheme.titleLarge!.copyWith(
                    color: Theme.of(context).primaryColorDark,
                    fontWeight: FontWeight.bold,
                    fontFamily: 'Amiri',
