...
// import 'package:islami_app/feature/botton_nav_bar/ui/view/widget/ayah_star_menu%20.dart';
...
//                   context.read<VerseSelectionCubit>().selectVerse(surah, ayah);

//                   await AyahStarMenu.show(
//                     context: context,
//                     surah: surah,
//                     ayah: ayah,
//                     details: details,
...
class _QuranViewScreenState extends State<QuranViewScreen> {
  ...
  int getJuz(int page) {
    final pos = QuranPageIndex.firstAyahOnPage(page);
    return getJuzNumber(pos.surah, pos.ayah);
  }
}
